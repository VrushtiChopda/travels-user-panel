...
//             console.log(values);
//             console.log(packId, "packidpackidpackidpackidpackid")
...
//     // const handleAddMembers = (push) => {

//     //     push({ pfullname: '', pmobile: '', pgender: '', page: '' })
//     // }
//     return (
//         <>
...
//                                     <div className="col-lg-8 col-6 p-0 ps-3">
//                                         <h5>Per Person </h5>
...
//                                         <hr />
//                                     </div>
//                                     <div className="col-lg-4 col-6 p-0 pe-3">
//                                         <h5>{details.price}</h5>
...
//                                         <hr />
//                                     </div>
//                                     <button className='btn' style={{ background: 'rgb(159, 224, 203)' }}>Pay Now</button>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
